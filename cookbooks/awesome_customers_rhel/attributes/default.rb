...
default_unless['awesome_customers_rhel']['database']['host'] = '127.0.0.1'
default_unless['awesome_customers_rhel']['database']['root_username'] = 'root'

default_unless['awesome_customers_rhel']['database']['dbname'] = 'my_company'
default_unless['awesome_customers_rhel']['database']['admin_username'] = 'db_admin'
